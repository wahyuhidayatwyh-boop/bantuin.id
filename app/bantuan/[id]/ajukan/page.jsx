...
export default function AjukanBantuanPage() {
  ...
  const { requests, submitOffer } = useApp();
      ...
      <main className="flex-1 max-w-[1280px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <div className="bg-white border border-slate-200 rounded-[32px] p-6 sm:p-8 lg:p-10 shadow-xs">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            {/* Main Proposal Form (8 Columns on desktop, Order-1 on mobile) */}
                ...
                <div className="pt-2 border-t border-slate-100 space-y-3">
                  ...
                  {(showCVSection || cvFileName) && (
                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 animate-in fade-in duration-150 space-y-2">
                      ...
                      {cvFileName ? (
                        <div className="flex items-center justify-between p-3 bg-indigo-50 border border-indigo-200 rounded-xl text-xs font-bold text-indigo-900">
                        ...
                        <label className="border border-dashed border-slate-300 hover:border-indigo-400 rounded-xl p-3.5 text-center cursor-pointer transition bg-white block text-xs font-semibold text-indigo-700">
            ...
            <div className="lg:col-span-4 lg:border-l lg:border-slate-100 lg:pl-8 space-y-6 order-2">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-900">Xendit Escrow Protection</div>
                  <p className="text-[11px] text-slate-500 mt-0.5 leading-snug">
                    Dana imbalan ditampung aman di rekening bersama. Dana otomatis cair ke saldo Anda setelah tugas disetujui.
                  </p>
                </div>
              </div>
