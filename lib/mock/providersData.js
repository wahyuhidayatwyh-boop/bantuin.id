...
export const PROVIDERS_DATA = [
  ...
  },
  {
    id: "bagus-wicaksono-helper",
    name: "Bagus Wicaksono",
    brandTitle: "Tenaga Bantuan Antar Barang, Titip & Errand Kilat",
    type: "helper",
    category: "Helper",
    categoryLabel: "Kurir & Bantuan Kilat",
    avatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=400&q=80",
    coverBanner: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1200&q=80",
    rating: 4.95,
    reviewsCount: 34,
    completedJobs: 56,
    responseTime: "5 menit",
    location: "Purwokerto Utara (Kampus Unsoed)",
    distanceMeters: 400,
    address: "Jl. HR Bunyamin No. 12, Grendeng, Purwokerto Utara, Banyumas",
    city: "Kabupaten Banyumas",
    latitude: -7.4125,
    longitude: 109.2465,
    isVerified: true,
    verificationBadge: "Tenaga Bantuan Terverifikasi",
    bio: "Warga Purwokerto yang aktif dan terpercaya. Siap membantu kebutuhan mobilitas kilat seperti antar-jemput dokumen, titip belanja mendesak, atau errand harian di sekitar kampus Unsoed & perkantoran.",
    badges: ["Respon Cepat", "Motor Siaga", "Tas Anti Air", "Rekber Resmi"],
    skills: ["Antar Barang", "Titip Dokumen", "Errand Cepat", "Belanja Harian", "Antar Makanan"],
    catalog: [
      {
        id: "cat-bw-1",
        title: "Antar Jemput Dokumen & Berkas Kampus",
        image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80",
        price: 20000,
        unit: "/ rute",
        category: "Dokumen",
        desc: "Pengantaran dokumen penting bebas lecek dengan map pelindung anti air."
      },
      {
        id: "cat-bw-2",
        title: "Titip Belanja Kebutuhan Harian / Obat Apotek",
        image: "https://images.unsplash.com/photo-1580674684081-7617fbf3d745?auto=format&fit=crop&w=600&q=80",
        price: 25000,
        unit: "/ rute",
        category: "Belanja",
        desc: "Belanja makanan, perlengkapan kos, atau obat di apotek terdekat dengan struk transparan."
      },
      {
        id: "cat-bw-3",
        title: "Bantuan Antri Loket & Legalisir Berkas",
        image: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=600&q=80",
        price: 30000,
        unit: "/ jam",
        category: "Antri",
        desc: "Membantu antri loket, stempel birokrasi kampus, atau kebutuhan administrasi."
      }
    ],
    packages: [
      {
        id: "pkg-bw-1",
        name: "Paket Antar Kilat Dalam Kota",
        tier: "Paket Hemat",
        price: 25000,
        duration: "30 Menit",
        description: "Pengantaran kilat barang/dokumen ringkas area Purwokerto.",
        features: ["Penjemputan Langsung", "Tas Kurir Anti Air", "Bukti Foto Sampai"],
        isPopular: true
      },
      {
        id: "pkg-bw-2",
        name: "Paket Errand Multistop (2-3 Titik)",
        tier: "Paket Standar",
        price: 50000,
        duration: "1 - 2 Jam",
        description: "Bantuan beberapa urusan sekaligus dalam satu kali jalan.",
        features: ["Hingga 3 Titik Pengantaran/Belanja", "Struk Pembelian Transparan", "Update Status Realtime"],
        isPopular: false
      }
    ],
    portfolioPhotos: [
      {
        ...
        title: "Antar Berkas TU Unsoed",
        description: "Pengantaran berkas skripsi tepat waktu.",
        category: "Dokumen"
      }
    ],
    reviews: [
      {
        ...
        rating: 5,
        date: "19 Sep 2026",
        packageName: "Paket Antar Kilat Dalam Kota",
        comment: "Mas Bagus gercep banget! Berkas penting sampai di TU Unsoed tepat waktu tanpa lecek sama sekali."
      }
    ]
  },
  {
    id: "dwi-prasetyo-helper",
    name: "Dwi Prasetyo",
    brandTitle: "Tenaga Bantuan Pindahan Kos & Angkut Berat",
    type: "helper",
    category: "Helper",
    categoryLabel: "Bantuan Tenaga & Pindahan",
    avatar: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?auto=format&fit=crop&w=400&q=80",
    coverBanner: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1200&q=80",
    rating: 4.90,
    reviewsCount: 28,
    completedJobs: 42,
    responseTime: "8 menit",
    location: "Sokaraja & Purwokerto Timur",
    distanceMeters: 850,
    address: "Jl. Suparjo Rustam No. 24, Sokaraja, Banyumas",
    city: "Kabupaten Banyumas",
    latitude: -7.4421,
    longitude: 109.2683,
    isVerified: true,
    verificationBadge: "Tenaga Angkut Terverifikasi",
    bio: "Fisik bugar, amanah, dan terbiasa angkut perabotan berat. Berpengalaman membantu angkat kasur springbed, lemari jati, kulkas, meja kos, serta bongkar muat pickup dengan perlengkapan tali & troli.",
    badges: ["Tenaga Terverifikasi", "Troli & Tali Siap", "Jaminan Barang Aman", "Rekber Resmi"],
    skills: ["Bantu Angkat", "Pindahan Kos", "Bongkar Muat Pickup", "Pertolongan Motor Mogok", "Belanja Grosir"],
    catalog: [
      {
        id: "cat-dw-1",
        title: "Bantuan Angkat Kasur Springbed & Lemari",
        image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=600&q=80",
        price: 45000,
        unit: "/ sesi",
        category: "Pindahan",
        desc: "Angkat barang berat naik/turun lantai kos tanpa resiko dinding terbentur."
      },
      {
        id: "cat-dw-2",
        title: "Bongkar Muat Barang Mobil Pickup",
        image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=600&q=80",
        price: 65000,
        unit: "/ pickup",
        category: "Logistik",
        desc: "Menaikkan dan menurunkan muatan dengan troli lipat dan tali pengikat kokoh."
      },
      {
        id: "cat-dw-3",
        title: "Bantuan Dorong / Stut Motor Mogok",
        image: "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?auto=format&fit=crop&w=600&q=80",
        price: 35000,
        unit: "/ titik",
        category: "Darurat",
        desc: "Bantuan cepat stut motor ke bengkel terdekat area Sokaraja & Purwokerto."
      }
    ],
    packages: [
      {
        id: "pkg-dw-1",
        name: "Paket Angkut Ringan Kos",
        tier: "Paket Hemat",
        price: 45000,
        duration: "1 Jam",
        description: "Bantuan angkat kasur dan kardus pakaian kamar kos.",
        features: ["Angkat Perabotan Ringan-Sedang", "Naik Turun Lantai 1-2", "Cepat & Rapi"],
        isPopular: false
      },
      {
        id: "pkg-dw-2",
        name: "Paket Pindahan Total Sekamar Kos",
        tier: "Paket Standar",
        price: 85000,
        duration: "2 - 3 Jam",
        description: "Bantuan komplit pindahan seluruh perabotan kamar kos.",
        features: ["Tenaga Angkat Kasur, Lemari & Kulkas", "Troli Lipat & Tali Pengaman", "Bongkar Muat Pickup", "Bantuan Penataan Kos Baru"],
        isPopular: true
      }
    ],
    portfolioPhotos: [
      {
        url: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80",
        title: "Bongkar Muat Pickup Sokaraja",
        description: "Penataan aman muatan kasur dan perabot kos.",
        category: "Pindahan"
      }
    ],
    reviews: [
      {
        ...
        rating: 5,
        date: "16 Sep 2026",
        packageName: "Paket Pindahan Total Sekamar Kos",
        comment: "Pindahan kos jadi santai berkat Mas Dwi. Barangnya dijaga dengan baik tanpa lecet."
      }
    ]
  },
  {
    id: "rina-astuti-helper",
    name: "Rina Astuti",
    brandTitle: "Asisten Administrasi, Print Tugas & Event",
    type: "helper",
    category: "Helper",
    categoryLabel: "Bantuan Administrasi & Event",
    avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=400&q=80",
    coverBanner: "https://images.unsplash.com/photo-1580674684081-7617fbf3d745?auto=format&fit=crop&w=1200&q=80",
    rating: 4.92,
    reviewsCount: 19,
    completedJobs: 31,
    responseTime: "3 menit",
    location: "Kembaran (Dekat Kampus UMP)",
    distanceMeters: 1200,
    address: "Jl. KH Ahmad Dahlan No. 5, Dukuhwaluh, Banyumas",
    city: "Kabupaten Banyumas",
    latitude: -7.419,
    longitude: 109.271,
    isVerified: true,
    verificationBadge: "Identitas Terverifikasi",
    bio: "Mahasiswi aktif di Banyumas. Teliti, cekatan, dan rapi dalam mengurus administrasi kampus, print & jilid skripsi, ambil paket kurir, serta penjagaan stand/booth pameran.",
    badges: ["Respon Kilat", "Teliti & Rapi", "Ramah", "Rekber Resmi"],
    skills: ["Print Tugas", "Ambil Paket", "Jaga Stand Event", "Legalisir Berkas", "Belanja Skripsi"],
    catalog: [
      {
        id: "cat-rn-1",
        title: "Titip Print Laporan & Jilid Skripsi",
        image: "https://images.unsplash.com/photo-1580674684081-7617fbf3d745?auto=format&fit=crop&w=600&q=80",
        price: 20000,
        unit: "/ berkas",
        category: "Administrasi",
        desc: "Pengecekan kelengkapan halaman cetak dan jilid rapi di percetakan kampus."
      },
      {
        id: "cat-rn-2",
        title: "Ambil Paket Kurir / Ekspedisi Kos",
        image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80",
        price: 15000,
        unit: "/ paket",
        category: "Errand",
        desc: "Mengambilkan paket besar di agen J&T/JNE saat Anda sedang kuliah atau di luar kota."
      },
      {
        id: "cat-rn-3",
        title: "Jasa Penjaga Stand / Booth Pameran",
        image: "https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=600&q=80",
        price: 80000,
        unit: "/ 4 jam",
        category: "Event",
        desc: "Menjaga stand bazar atau pameran dengan komunikasi ramah dan pembukuan rapi."
      }
    ],
    packages: [
      {
        id: "pkg-rn-1",
        name: "Paket Titip Cetak & Antar Kos",
        tier: "Paket Hemat",
        price: 25000,
        duration: "1 - 2 Jam",
        description: "Solusi tugas kuliah mepet waktu.",
        features: ["Print & Jilid Rapih", "Plastik Pelindung Hujan", "Antar Langsung ke Kamar Kos"],
        isPopular: true
      },
      {
        id: "pkg-rn-2",
        name: "Paket Asisten Stand Acara (Half-day)",
        tier: "Paket Standar",
        price: 80000,
        duration: "4 Jam",
        description: "Penjaga booth acara kampus dan pameran UMKM.",
        features: ["Penjagaan Booth Standby", "Pencatatan Tamu / Transaksi", "Komunikatif & Berpenampilan Rapi"],
        isPopular: false
      }
    ],
    portfolioPhotos: [
      {
        ...
        title: "Pengecekan Jilid Laporan Kampus",
        description: "Pemeriksaan margin dan halaman sebelum serah terima.",
        category: "Cetak"
      }
    ],
    reviews: [
      {
        ...
        rating: 5,
        date: "17 Sep 2026",
        packageName: "Paket Titip Cetak & Antar Kos",
        comment: "Mbak Rina teliti banget cek jilid skripsi sebelum dikirim. Recommended banget!"
      }
    ]
  },
  {
    id: "ahmad-rizky-helper",
    name: "Ahmad Rizky",
    brandTitle: "Kurir Kilat, Jemput Berkas & Errand Cepat",
    type: "helper",
    category: "Helper",
    categoryLabel: "Kurir Kilat & Errand",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80",
    coverBanner: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1200&q=80",
    rating: 4.88,
    reviewsCount: 22,
    completedJobs: 38,
    responseTime: "10 menit",
    location: "Purwokerto Barat (Dekat Stasiun)",
    distanceMeters: 1500,
    address: "Jl. Kober No. 88, Purwokerto Barat, Banyumas",
    city: "Kabupaten Banyumas",
    latitude: -7.4201,
    longitude: 109.2215,
    isVerified: true,
    verificationBadge: "Kurir Motor Terverifikasi",
    bio: "Siap siaga di area barat kota dan Stasiun Purwokerto. Sigap membantu titip jemput barang di stasiun, antar berkas darurat, belanja kebutuhan harian, hingga antri tiket/obat.",
    badges: ["Motor Siap", "Tas Anti Air", "Radius Luas", "Rekber Resmi"],
    skills: ["Jemput Berkas", "Bantu Acara", "Errand Kilat", "Antri Tiket/RS", "Kurir Cepat"],
    catalog: [
      {
        id: "cat-ar-1",
        title: "Titip Ambil / Kirim Barang di Stasiun",
        image: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=600&q=80",
        price: 25000,
        unit: "/ rute",
        category: "Stasiun",
        desc: "Ambil barang titipan dari kerabat yang naik kereta di Stasiun Purwokerto."
      },
      {
        id: "cat-ar-2",
        title: "Bantuan Antri Obat RS / Beli Makanan",
        image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=600&q=80",
        price: 35000,
        unit: "/ sesi",
        category: "Antri",
        desc: "Membantu mengambilkan antrian poliklinik atau tebus resep obat."
      },
      {
        id: "cat-ar-3",
        title: "Errand Belanja Mendesak Minimarket/Pasar",
        image: "https://images.unsplash.com/photo-1580674684081-7617fbf3d745?auto=format&fit=crop&w=600&q=80",
        price: 20000,
        unit: "/ toko",
        category: "Belanja",
        desc: "Belanja kebutuhan darurat tengah malam atau saat sakit tidak bisa keluar kos."
      }
    ],
    packages: [
      {
        id: "pkg-ar-1",
        name: "Paket Kurir Cepat Stasiun",
        tier: "Paket Hemat",
        price: 30000,
        duration: "45 Menit",
        description: "Pengantaran kilat dari/ke Stasiun Purwokerto.",
        features: ["Penjemputan Tepat Waktu", "Update Posisi Realtime", "Bukti Foto Tanda Terima"],
        isPopular: true
      },
      {
        id: "pkg-ar-2",
        name: "Paket Antri & Errand Terjadwal",
        tier: "Paket Standar",
        price: 60000,
        duration: "2 Jam",
        description: "Bantuan antri keperluan penting atau belanja komplit.",
        features: ["Standby Mengantri 2 Jam", "Struk Pembelian Transparan", "Kirim Langsung ke Alamat"],
        isPopular: false
      }
    ],
    portfolioPhotos: [
      {
        url: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=800&q=80",
        title: "Penjemputan Berkas Stasiun Purwokerto",
        description: "Pengambilan paket kilat kereta api tepat waktu.",
        category: "Kurir"
      }
    ],
    reviews: [
      {
        id: "rev-ar-1",
        userName: "Hendro Gunawan",
        userAvatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=120&q=80",
        rating: 5,
        date: "18 Sep 2026",
        packageName: "Paket Kurir Cepat Stasiun",
        comment: "Respon chat cepat dan langsung meluncur ke stasiun. Sangat membantu di saat darurat."
      }
    ]
  }
];
